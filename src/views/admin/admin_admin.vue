<template>
  <div class="mb-8">
        ...
        <div class="row">
          ...
          <div class="col-2 col-sm-2 col-lg-1">
            <v-badge bordered overlap icon="mdi-plus" color="#7CB342">
              ...
              <div class="d-flex justify-content-center">
                <p><span class="save">Crear producto</span></p>
              </div>
            </v-badge>
          </div>
    ...
    <!-- la logica es, si se puede crear un producto, es porque no hay categorias para mostrar
     ...
     -->
    <div
      class="categorias_principales container d-flex justify-content-center"
      v-if="categories.length > 0"
    >
      <div class="row mb-8">
        <div
          class="card col-11 col-sm-11 col-lg-3 m-1"
            ...
            <div class="row d-flex align-items-center">
              <div class="col-6 col-sm-6">
                <a @click="GetSubCategoria(categoria)">
                  <img
                    class="categoria_image mb-2 mr-1"
                    :src="categoria.image"
                    alt=""
                  />
                </a>
                  ...
                  <div class="row mt-1 mb-2 d-flex align-items-center">
                    <div class="col-2">
                      <v-btn
                        ...
                        icon
                        outlined
                        @click="GoToProductStatistics(product)"
                        ><font-awesome-icon icon="fa-chart-line" />
                      </v-btn>
                    </div>
                    <div class="col-6">
                      <span
                        ><a class="statistics_a" @click="GoToProductStatistics(product)">
                        ESTADISTICAS</a></span
                      >
                    </div>
                    <div class="col-2"></div>
                  ...
                  <form>
                    ...
                    <div class="mb-3">
                      ...
                      <p
                        ...
                        v-if="!$v.createProduct_image.required"
                      >
                        * Campo requerido.
                      </p>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input
                        ...
                        v-model="$v.createProduct_title.$model"
                        :class="{ 'is-invalid': $v.createProduct_title.$error }"
                      />
                    </div>
                    ...
                    <p
                      class="text-danger mt-1"
                      style="font-size: 12px !important"
                      v-if="!$v.createProduct_title.required"
                    >
                      * Campo requerido.
                    </p>
                    <p
                      class="text-danger mt-1"
                      style="font-size: 12px !important"
                      v-if="!$v.createProduct_title.minLength"
                    >
                    ...
                    <div class="mb-3">
                      ...
                      <textarea
                        ...
                        id="Descripcion"
                        rows="3"
                        v-model="$v.createProduct_description.$model"
                        :class="{
                          'is-invalid': $v.createProduct_description.$error,
                        }"
                      ></textarea>
                    </div>
                    <p
                      class="text-danger mt-1"
                      style="font-size: 12px !important"
                      v-if="!$v.createProduct_description.required"
                    >
                      * Campo requerido.
                    </p>
                    ...
                    <p
                      class="text-danger mt-1"
                      style="font-size: 12px !important"
                      v-if="!$v.createProduct_description.minLength"
                    >
                      la descripcion debe tener al menos 8 caracteres
                    </p>

                    <v-switch
                      v-model="createProduct.has_options"
                      label="Con Opciones"
                    ></v-switch>
                    <v-divider></v-divider>
                    ...
                    <div class="mb-1">
                      <v-switch
                        v-model="createProduct.no_stock"
                        label="Sin control de stock"
                      ></v-switch>
                    </div>
                    <div class="mb-3" v-if="createProduct.no_stock == false">
            ...
            <div class="row">
              <div class="col-12 col-sm-12">
                <form>
                  ...
                  <v-switch
                    v-model="setEditProduct.has_options"
                    label="Con Opciones"
                  ></v-switch>
...
export default {
  ...
  data() {
    return {
      ...
      typeProductSelect: { text: "Producto fisico", value: "pdf" },
      typeProduct: [
        { text: "Producto fisico", value: "pdf" },
        { text: "Ticket/Entrada", value: "tck" },
      ],
      createProduct_title: "",
      createProduct_description: "",
      createProduct_image: null,
      createProduct: {
        marca: "",
        title: "",
        description: "",
  ...
  validations: {
    createProduct_title: { required, minLength: minLength(4) },
    createProduct_description: { required, minLength: minLength(8) },
    createProduct_image: { required },
  },
  created() {
    this.Guard();
  },
  ...
  methods: {
    ...
    UpdateProduct() {
      ...
      data.append("tienda", this.tienda.id);
      data.append("has_options", this.setEditProduct.has_options);
      data.append("only_attribute", true);
      data.append("marca", this.setEditProduct.marca);
      data.append("no_stock", this.setEditProduct.no_stock);
    ...
    uploadImage(e) {
      ...
      for (let i = 0; i < selectedFiles.length; i++) {
        ...
        if (
          this.product_more_images.length > this.tienda.plan.images_x_products
        ) {
          this.$swal.fire(
            "Limite Excedido!",
    ...
    CreateProduct() {
      ...
      const id_category = this.breadcrumbs[this.breadcrumbs.length - 1]["id"];
      data.append("category", id_category);
      data.append("title", this.createProduct_title);
      data.append("description", this.createProduct_description);
      data.append("image", this.createProduct_image);
      data.append("price", this.createProduct.price);
      data.append("stock", this.createProduct.stock);
      data.append("no_stock", this.createProduct.no_stock);
      ...
      data.append("has_options", this.createProduct.has_options);
      data.append("tienda", this.tienda.id);
      data.append("only_attribute", this.createProduct.only_attribute);
      data.append("marca", this.createProduct.marca.toLowerCase());
      data.append("type", this.typeProductSelect);
      ...
      if (this.$v.$invalid) {
        ...
        axios
          ...
          .then((response) => {
            ...
            (this.createProduct_title = ""),
              (this.createProduct_description = ""),
              (this.createProduct_image = null),
              (this.createProduct = {
                marca: "",
                title: "",
                description: "",
    ...
    GoToProductStatistics(product) {
      console.log("GoToProductStatistics");
      console.log("PRODUCT");
      console.log(product);
      this.$router.push({
