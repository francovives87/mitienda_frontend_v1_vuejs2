<template>
  <div class="user_all_bookings mt-12">
    <main_user_menu />
    <div class="container">
      <div class="row">
              ...
              <div class="row">
                  <div class="row">
                    <div class="col-12 col-sm-12">
                      ...
                      >
                      <p class="orden_nueva">
                        <span>Servicio: </span> <span>{{booking.service.title}}</span><br />
                        <span>Descripcion: </span><span>{{booking.service.description}}</span>
                        <v-divider></v-divider>
                        <span class="booking_important">Dia: </span><span class="booking_important_data">{{booking.date}}</span><br>
                        <span class="booking_important" >Hora: </span> <span class="booking_important_data"> {{booking.time}}</span>
                      </p>
                    </div>
                  </div>
              </div>
