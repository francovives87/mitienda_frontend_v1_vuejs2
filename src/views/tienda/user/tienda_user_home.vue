      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <div class="ordenes_recientes">
            ...
            <span class="ml-2"> Mis ultimas compras en {{tienda.title}}</span>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
          <div class="col-12 col-sm-12">
            ...
            >
              <router-link
                :to="{ name: 'tienda_user_order_detail', params: { order: order.id } }"
              >
                <div class="card-body">
                  <h5 class="card-title">
                    <font-awesome-icon icon="shopping-bag" />
...
export default {
  ...
  methods: {
    ...
    GetOrdersUser() {
      ...
      axios
        .get(this.server + "/api/v1.0/tienda/orders/list/user/", {
          params: {
