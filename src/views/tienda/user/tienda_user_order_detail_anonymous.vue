      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-sm-12">
            <h6 style="color:green;">Orden Creada exitosamente! muchas gracias.</h6>
          </div>
          <div class="col-12 col-sm-12" v-if="approved == true">
            <div class="success text-white" >
              COMPRA APROBADA!
            </div>
          </div>
          <div class="col-12 col-sm-12" v-if="rejected == true">
        ...
        <div class="col-12 col-sm-12">
          <h6>#ID de la orden: {{ orderDetail.id }}</h6>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 col-sm-12">
                    <p class="detalle_orden">
                      Al ser una orden anonima, los datos personales, solo los puede ver el 
                      administrador de la tienda, por cuestiones de seguridad. <br>
                      <span style="color:black;">RECUERDE GUARDAR EL ID DE LA ORDEN, PARA IDENTIFICARLA</span>
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    GetOrder() {
      axios
        .get(this.server + "/api/v1.0/orders/anonymous/detail/" + this.order, {
          headers: {
