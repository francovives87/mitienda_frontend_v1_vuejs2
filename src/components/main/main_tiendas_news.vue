    ...
    <div class="row d-flex align-items-center">
      ...
      >
        <span class="title_bar"
          ><font-awesome-icon icon="fa-cart-plus" /> TIENDAS NUEVAS CERCANAS
        </span>
      </div>
      <div class="col-4 col-sm-4 col-lg-5"><hr /></div>
      <div class="row">
        <div class="col-12 col-sm-12">
          <carousel
            ...
            :loop="true"
          >
            <slide v-for="(tienda, i) in tiendas_news" :key="i">
                      ...
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-12">
                          ...
                          <p class="tienda_description">
                            ...
                            <span class="location"> {{ tienda.ciudad }}</span>
                            <br />
...
export default {
  ...
  methods: {
    GetNewsStoresNears() {
      axios
        .get(this.server + "/api/v1.0/store/geo/news/", {
          params: {
        ...
        .then((response) => {
          console.log("GetNewsStores");
          console.log(response.data.results);
          this.tiendas_news = response.data.results;
        })
        .catch((error) => {
          console.log(error);
        });
