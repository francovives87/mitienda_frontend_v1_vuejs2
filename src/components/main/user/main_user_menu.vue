    ...
    <v-navigation-drawer v-model="drawer" absolute temporary>
      ...
      <v-list dense>
        <v-list-item>
          ...
          <v-list-item-content>
            <router-link :to="{ name: 'main_account' }">
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <router-link :to="{ name: 'main_user_all_orders' }">
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <router-link :to="{ name: 'main_user_all_bookins' }">
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <router-link :to="{ name: 'main_user_personal_dates' }">
