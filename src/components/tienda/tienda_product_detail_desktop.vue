<template>
  <div class="tienda_product_detail_mobile" :style="Home">
          ...
          <div class="container">
            <div class="row mb-1">
              ...
              <div class="container" v-if="productDetail.in_offer == true">
                <div class="row">
                  <div class="col-12 col-sm-12">
                    <h6 style="color: green">producto con descuento!</h6>
                    <p>
                      <span class="oldPrice">{{ productDetail.price }}</span>
                    </p>

                    <h3 class="newPrice">
                      $ {{ productDetail.in_offer_price }}
                    </h3>
                    <p>
                      {{ productDetail.category.name }}
                    </p>
            ...
            <div class="row card">
                    ...
                    >
                      <div class="col-2 col-sm-2">
                        <v-btn
                          elevation="4"
                          icon
                          @click="Decrease_quantity_oatt()"
                        >
                          <v-icon>mdi-minus</v-icon>
                        </v-btn>
                      </div>
                      <div class="col-2 col-lg-2 ml-2 mr-2">
              ...
              <div
                class="only_attribute"
                v-if="productDetail.only_attribute == true"
              >
                <div class="container">
                  <div class="row d-flex justify-content-center">
                    <div
              ...
              <div class="container">
                <div class="row mt-4" v-if="attributes_selected.length > 0">
                  <h6>selecciono:</h6>
                  <div class="col-12 col-lg-12 col-sm-12 mt-2">
                    <div
              ...
              <div
                class="container"
                v-if="flagResultadoBusquedaVariaciones == 0"
              >
                <div class="row d-flex justify-content-center">
              ...
              <div
                class="container"
                v-if="flagResultadoBusquedaVariaciones == 2"
              >
                <div class="row d-flex justify-content-center">
              ...
              <!-- Solo atributos -->
              <v-card elevation="2" outlined v-if="onlyAttibute == true">
                <v-card-text>
                  <div class="row d-flex justify-content-center">
                    <div
                      class="
                        col-8 col-sm-12 col-lg-8
                        d-flex
                        justify-content-center
                        align-items-center
                      "
...
export default {
  name: "tienda_product_detail_desktop",
  components: {
    Carousel,
    Slide,
    tienda_barra_mobile,
      ...
      if (!this.tienda.name) {
        ...
        if (this.tienda.tienda_colors[0].hasTexture == false) {
          ...
          return (
            ...
            ")  !important; background-repeat: repeat !important; height:100% !important;"
          );
        }
      }
    },
