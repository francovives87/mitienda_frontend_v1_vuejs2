<template>
  <div class="informacion" :style="tienda_info_style">
      ...
      <div class="container">
        <div class="row">
          <v-tabs class="d-flex justify-content-center">
            <v-tab :style="tab_style" @click="ChangeTienda('tienda')"
              >TIENDA</v-tab
            >
            <v-tab :style="tab_style" @click="ChangeTienda('ubicacion')"
              >UBICACION</v-tab
            >
            <v-tab :style="tab_style" @click="ChangeTienda('horarios')"
              >HORARIOS</v-tab
            >
          </v-tabs>
        </div>
    ...
    <div class="information_container">
      <div class="container" v-if="vista === 'tienda'">
        <div class="row d-flex justify-content-center">
          <div class="col-6 col-sm-6 col-lg-3">
            <span :style="info_title_style"> {{ tienda.title }} </span> <br />
            <span :style="info_description_style">{{
              tienda.description.substring(0, 20)
            }}</span>
            <br />
            ...
            >
            <br />
            <div class="row" v-if="tienda.qr_code.length > 0">
              <div class="col-12">
                <a data-bs-toggle="modal" data-bs-target="#qrModal">
                  <img :src="tienda.qr_code[0].qr_code" class="img_qr_code" />
                </a>
              </div>
            </div>
          </div>
      ...
      <!-- ubicacion -->
      <div class="container" v-if="vista === 'ubicacion'">
      ...
      <!-- horarios -->
      <div class="container" v-if="vista === 'horarios'">
        <div class="row d-flex justify-content-center">
    ...
    <div class="botonera">
      ...
      <div class="container">
        <div class="row d-flex justify-content-end">
          <div class="col-2 col-sm-2 col-lg-1" v-if="user_store.id > 0">
            <v-btn
              elevation="4"
              icon
              small
              ...
              class="mr-2"
            >
              <v-icon color="red" style="font-size: 18px">mdi-heart</v-icon>
            </v-btn>
          </div>
    ...
    >
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row d-flex justify-content-center">
              <img :src="tienda.logo" style="width: 100px; heigth: 100px" />
            </div>
            <div class="row d-flex justify-content-center">
              <img
                :src="tienda.qr_code[0].qr_code"
                style="width: 250px; heigth: 250px"
              />
            </div>
            <div class="row mt-8 d-flex justify-content-center align-items-center">
              ...
              <div class="col-4 p-0">
                <span
                  style="color: #a463bf !important; font-size: 22px !important"
                >
                  mitienda.app
                </span>
              </div>
...
export default {
  name: "tienda_informacion_mobile",
  ...
  methods: {
    ...
    UpdateUserOpinion() {
      ...
      axios
        .put(
          this.server +
            "/api/v1.0/tienda/opinion/user/update/" +
            this.userOpinion.id,
          data,
          {
            headers: {
              ...
              .then((result) => {
                if (result.isConfirmed) {
                  axios
                    .delete(
                      this.server +
                        "/api/v1.0/store/favorites/delete/" +
                        response.data.id
                    )
                    .then(() => {
                      this.$swal.fire(
