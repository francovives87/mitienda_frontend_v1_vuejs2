<template>
  <div class="product_new" v-if="productsNews.length > 0">
    <div class="product_new_mobile" v-if="height == 1 || height == 2">
      <div class="container">
        <div class="row">
              ...
              <div class="row p-0 ml-3">
                <div class="col-8 col-sm-8 col-lg-8">
                  <a @click="GoToExplorer()">
                    ...
                    <span class="title_font"> PRODUCTOS NUEVOS </span>
                  </a>
                </div>
                <div
                  class="
      ...
      <div class="container">
        <div class="row">
          <div
            :class="
              height == 2
                ? 'col-6 col-lg-4 col-sm-6'
                : 'col-12 col-sm-12 col-lg-3'
            "
            v-for="(item, i) in productsNews"
            :key="i"
          >
            <div class="card products">
              ...
              <div class="card-body">
                <p class="product_description">
                  ...
                  <span
                    :class="
                      item.in_offer == true ? 'old_price' : 'product_price'
                    "
                  >
                    $ {{ item.price }}
                  </span>
    ...
    <div class="product_new_mobile" v-if="height > 2">
      <div class="container">
        <div class="row">
      ...
      <v-container>
        <carousel
          ...
          :loop="true"
        >
          <slide v-for="(item, i) in productsNews" :key="i">
            <div class="card products">
              <a @click="GoToDetail(item)">
                <img :src="item.image" alt="" />
                <div class="oferta" v-if="item.in_offer == true">En oferta</div>
